...
export class AuthApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async login(xDeviceIdentifier?: string, xClientDeviceId?: string, loginRequest?: LoginRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Header Params
        requestContext.setHeaderParam("x-device-identifier", ObjectSerializer.serialize(xDeviceIdentifier, "string", ""));

        // Header Params
        requestContext.setHeaderParam("x-client-device-id", ObjectSerializer.serialize(xClientDeviceId, "string", ""));
